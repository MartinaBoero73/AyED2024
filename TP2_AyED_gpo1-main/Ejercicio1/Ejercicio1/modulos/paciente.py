...
# -*- coding: utf-8 -*-
"""
Created on Mon May  8 10:23:16 2023

@author: Breggia Bruno
"""
...
class Paciente:
    ...
    def __lt__(self, pac):
        if self.__riesgo < pac.__riesgo:
            return True
        elif self.__riesgo > pac.__riesgo:
            return False
        else:
        # En caso de tener igual riesgo, compara por orden de llegada
            return self.lugar < pac.lugar
